...
if test $DETECT_ONLY -ne 1; and test -z "$SERVER_MODELS_DIR"; and not test -f "$MODEL"
...
# Only set default LLAMA_DIR if not already set (don't override --llama-dir argument)
